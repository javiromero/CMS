...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TestimoniosConfig'
        db.create_table('testimonios_testimoniosconfig', (
            ...
            ('titulo_lat', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('texto_lat', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('analytics', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('imagen', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100)),
        ))
        db.send_create_signal('testimonios', ['TestimoniosConfig'])

        # Adding model 'Testimonios'
        db.create_table('testimonios_testimonios', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('comentario', self.gf('django.db.models.fields.CharField')(max_length=220)),
            ...
            ('categoria', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.Category'], blank=True)),
            ('pagina', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Pagina'], blank=True)),
        ))
        db.send_create_signal('testimonios', ['Testimonios'])


    def backwards(self, orm):
        
        # Deleting model 'TestimoniosConfig'
        db.delete_table('testimonios_testimoniosconfig')

        # Deleting model 'Testimonios'
        db.delete_table('testimonios_testimonios')
    ...
    models = {
        ...
        'testimonios.testimonios': {
            ...
            'comentario': ('django.db.models.fields.CharField', [], {'max_length': '220'}),
            'creado_el': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'es_activo': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'imagen': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '100'}),
